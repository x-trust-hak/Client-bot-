...
m.sender: ${m.sender}
m.from: ${m.from}
normalizeJid(m.sender): ${normalizeJid(m.sender)}
phoneNumber: ${phoneNumber}
conn.user.id: ${conn?.user?.id}
normalizeJid(conn.user.id): ${normalizeJid(conn?.user?.id)}
senderIsOwner would be: ${normalizeJid(m.sender) === phoneNumber || normalizeJid(m.sender) === normalizeJid(conn?.user?.id)}
