...
Platform: ${os.platform()} (${os.arch()})
            ...
            case "editbotpic": {
                ...
                if (!m.quoted || m.quoted.mtype !== 'imageMessage') {
                    await conn.sendMessage(m.from, { text: `❌ Reply to an image with ${prefix}editbotpic to set it as this session's profile picture.` }, { quoted: m });
                    break;
                }
                ...
                try {
                    ...
                    await conn.sendMessage(m.from, { text: `❌ Failed to update profile picture. Make sure it's a regular image (not a sticker or document).` }, { quoted: m });
                }
                break;
            }
