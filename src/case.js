...
Platform: ${os.platform()} (${os.arch()})
            ...
            // ════════════════════════════════════════════
            // 🎲 DISCOVERY / RANDOM PIC COMMANDS (free)
            // ════════════════════════════════════════════
            ...
            case "catpic": {
                try {
                    await conn.sendMessage(m.from, {
                        image: { url: `${TRUSTBIT_URL}/random/cat` },
                        caption: `🐱 *Random Cat*\n\n_Here's your cute cat!_ 🐾`
                    }, { quoted: m });
                } catch (err) {
                    console.error("catpic error:", err.message);
                    await conn.sendMessage(m.from, { text: "❌ Couldn't fetch a cat image right now. Try again!" }, { quoted: m });
                }
                break;
            }
            ...
            case "dogpic": {
                try {
                    await conn.sendMessage(m.from, {
                        image: { url: `${TRUSTBIT_URL}/random/dog` },
                        caption: `🐶 *Random Dog*\n\n_Here's your cute dog!_ 🦴`
                    }, { quoted: m });
                } catch (err) {
                    console.error("dogpic error:", err.message);
                    await conn.sendMessage(m.from, { text: "❌ Couldn't fetch a dog image right now. Try again!" }, { quoted: m });
                }
                break;
            }
            ...
            case "carpic": {
                try {
                    await conn.sendMessage(m.from, {
                        image: { url: `${TRUSTBIT_URL}/random/car` },
                        caption: `🚗 *Random Car*\n\n_Check out this ride!_ 🔥`
                    }, { quoted: m });
                } catch (err) {
                    console.error("carpic error:", err.message);
                    await conn.sendMessage(m.from, { text: "❌ Couldn't fetch a car image right now. Try again!" }, { quoted: m });
                }
                break;
            }
...
case "boypic": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/boypic` },
            caption: `👦 *Random Boy Pic*`
        }, { quoted: m });
    } catch (err) {
        console.error("boypic error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "girlpic": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/randomgirl` },
            caption: `👧 *Random Girl Pic*`
        }, { quoted: m });
    } catch (err) {
        console.error("girlpic error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "hijabgirl": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/hijabgirl` },
            caption: `🧕 *Random Hijab Girl*`
        }, { quoted: m });
    } catch (err) {
        console.error("hijabgirl error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "japgirl": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/japangirl` },
            caption: `🇯🇵 *Random Japan Girl*`
        }, { quoted: m });
    } catch (err) {
        console.error("japangirl error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "kgirl": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/koreangirl` },
            caption: `🇰🇷 *Random Korean Girl*`
        }, { quoted: m });
    } catch (err) {
        console.error("koreangirl error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "cgirl": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/chinagirl` },
            caption: `🇨🇳 *Random China Girl*`
        }, { quoted: m });
    } catch (err) {
        console.error("chinagirl error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "vgirl": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/vietnamgirl` },
            caption: `🇻🇳 *Random Vietnam Girl*`
        }, { quoted: m });
    } catch (err) {
        console.error("vietnamgirl error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "mgirl": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/malaysiagirl` },
            caption: `🇲🇾 *Random Malaysia Girl*`
        }, { quoted: m });
    } catch (err) {
        console.error("malaysiagirl error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "idgirl": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/indonesiagirl` },
            caption: `🇮🇩 *Random Indonesia Girl*`
        }, { quoted: m });
    } catch (err) {
        console.error("indonesiagirl error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "tgirl": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/thailandgirl` },
            caption: `🇹🇭 *Random Thailand Girl*`
        }, { quoted: m });
    } catch (err) {
        console.error("thailandgirl error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
    }
    break;
}
...
case "randompfp": {
    try {
        await conn.sendMessage(m.from, {
            image: { url: `${TRUSTBIT_URL}/random/profilepics` },
            caption: `🖼️ *Random Profile Picture*\n\n_Feel free to use this as your pfp!_`
        }, { quoted: m });
    } catch (err) {
        console.error("profilepic error:", err.message);
        await conn.sendMessage(m.from, { text: "❌ Couldn't fetch a profile picture right now. Try again!" }, { quoted: m });
    }
    break;
}
            ...
            case "bachar": {
                try {
                    await conn.sendMessage(m.from, {
                        image: { url: `${TRUSTBIT_URL}/random/bluearchive` },
                        caption: `💙 *Blue Archive*\n\n_Random Blue Archive character!_`
                    }, { quoted: m });
                } catch (err) {
                    console.error("bluearchive error:", err.message);
                    await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
                }
                break;
            }
            ...
            case "sfwpic": {
                try {
                    await conn.sendMessage(m.from, {
                        image: { url: `${TRUSTBIT_URL}/random/anhsfw` },
                        caption: `✨ *Random SFW Pic*`
                    }, { quoted: m });
                } catch (err) {
                    console.error("sfwpic error:", err.message);
                    await conn.sendMessage(m.from, { text: "❌ Couldn't fetch image right now. Try again!" }, { quoted: m });
                }
                break;
            }
            ...
            case "moegif": {
                try {
                    await conn.sendMessage(m.from, {
                        video: { url: `${TRUSTBIT_URL}/random/anhmoe` },
                        gifPlayback: true,
                        caption: `🎞️ *Random Moe GIF*`
                    }, { quoted: m });
                } catch (err) {
                    console.error("moegif error:", err.message);
                    await conn.sendMessage(m.from, { text: "❌ Couldn't fetch GIF right now. Try again!" }, { quoted: m });
                }
                break;
            }
