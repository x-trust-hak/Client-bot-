...
function storeMessage(m) {
    ...
    messageStore.set(m.id, {
        ...
        timestamp: Date.now(),
        key: m.key,
        message: m.message // full proto — needed by reaction view-once handler
    });
...
• ${prefix}vv (reply to view-once — reveals it)
• React with 👁️ on any view-once — bot silently DMs it to you
