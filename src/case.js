...
${lines.join('\n')}
            ...
            case "tovideo2": {
                ...
                // Static stickers can technically still run through ffmpeg here, but
                ...
                try {
                    ...
                    await conn.sendMessage(m.from, { text: `❌ Failed to convert sticker to video. Make sure it's actually animated.` }, { quoted: m });
                }
                break;
            }
