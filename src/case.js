...
module.exports = async (conn, m, chatUpdate, ctx = {}) => {
    ...
    try {
        ...
        const { data } = await axios.get(
            `https://trustbit-backend--trustsolo04.replit.app/api/ai/ch?query=${encodeURIComponent(text)}`,
            { timeout: 15000 }
        );
...
case "chatbot": {
    ...
    try {
        ...
        const { data } = await axios.get(
            `https://trustbit-backend--trustsolo04.replit.app/api/ai/chatbot?text=${encodeURIComponent(text)}`,
            { timeout: 15000 }
        );
...
case "everywhere": {
    ...
    try {
        ...
        const { data } = await axios.get(
            `https://trustbit-backend--trustsolo04.replit.app/api/ai/chateverywhere?text=${encodeURIComponent(text)}`,
            { timeout: 15000 }
        );
...
case "chatex": {
    ...
    try {
        ...
        const { data } = await axios.get(
            `https://trustbit-backend--trustsolo04.replit.app/api/ai/chatex?text=${encodeURIComponent(text)}`,
            { timeout: 15000 }
        );
...
case "convertcode": {
    ...
    try {
        ...
        const { data } = await axios.get(
            `https://trustbit-backend--trustsolo04.replit.app/api/ai/convertcode?code=${encodeURIComponent(code)}&target=${encodeURIComponent(target)}`,
            { timeout: 30000 }
        );
